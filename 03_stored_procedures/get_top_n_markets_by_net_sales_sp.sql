...
-- Purpose: Return top N markets by net sales for a given
--          fiscal year
-- Parameters:
...
-- Output: Top N markets ranked by net sales (in millions)
-- Difference from get_top_customers_by_net_sales:
--   No market filter — aggregates all markets globally
...
BEGIN
    ...
    -- --------------------------------------------------------
    -- OUTPUT: Top N markets by net sales (in millions)
    -- --------------------------------------------------------
    SELECT 
        market, 
