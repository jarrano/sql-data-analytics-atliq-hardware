-- ============================================================
-- Gross Sales Exploration — Croma India
...
--                get_monthly_gross_sales_for_customer_sp.sql
-- Dependencies: fact_sales_monthly, fact_gross_price,
--               dim_customer, get_fiscal_year() function
-- ============================================================

-- ------------------------------------------------------------
-- APPROACH 1: Direct JOIN with hardcoded customer code
-- First pass — validates logic before abstraction
-- ------------------------------------------------------------
SELECT 
    fsm.date, 
...
-- ------------------------------------------------------------
-- APPROACH 2: CTE version with named customer lookup
-- Replaces hardcoded customer code with a named CTE lookup
